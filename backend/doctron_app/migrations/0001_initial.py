...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AddConcept',
            fields=[
                ('username', models.OneToOneField(db_column='username', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='doctron_app.user')),
                ('insertion_time', models.TimeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('language', models.TextField()),
                ('start', models.OneToOneField(db_column='start', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='doctron_app.mention')),
                ('stop', models.IntegerField()),
                ('insertion_time', models.TimeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('language', models.TextField()),
                ('name', models.OneToOneField(db_column='name', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='doctron_app.label')),
                ('insertion_time', models.TimeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('document_id', models.OneToOneField(db_column='document_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='doctron_app.document')),
                ('language', models.TextField()),
                ('insertion_time', models.TimeField()),
        ...
        migrations.CreateModel(
            name='HasArea',
            fields=[
                ('concept_url', models.OneToOneField(db_column='concept_url', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='doctron_app.concept')),
            ],
            options={
                'db_table': 'has_area',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('collection_id', models.OneToOneField(db_column='collection_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='doctron_app.collection')),
